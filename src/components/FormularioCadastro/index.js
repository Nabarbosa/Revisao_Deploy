...
function FormularioCadastro() {
    ...
    const cadastrarUsuario = async () => {
        try {
            const response = await axios.post('https://db-backend-players.onrender.com/jogadores', {nome, sexo, idade, altura, peso, posicao, numeroCamisa})
            ...
            <div className="container-dir">
                ...
                <form onSubmit={(e) => {e.preventDefault(); cadastrarUsuario()}}>
                    ...
                    >
                        ...
                        <option value="FEMININO" disabled>Feminino</option>
